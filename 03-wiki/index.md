...
<section class="mh-intro">
  ...
  <div class="mh-profile">
    ...
    <img class="mh-avatar" src="./assets/chokebit-avatar.png" alt="Chokebit avatar" width="160" height="160" fetchpriority="high">
  </div>
</section>
...
<section id="about" class="mh-about">
  ...
  <p>This site keeps more than finished answers. It preserves the decisions behind a product: why it started, why it changed direction, what worked, and what ultimately failed. For business inquiries, please contact me by X DM first, or by email.</p>
