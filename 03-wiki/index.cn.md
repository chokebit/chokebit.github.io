...
<section class="mh-intro">
  ...
  <h1>你好，我是 <span>Chokebit</span>。</h1>
...
<section class="mh-now">
  ...
  <div>
    <h2>正在构建 Chokebit Wiki</h2>
    <p>把技术知识库升级为独立开发者的公开构建现场。</p>
  </div>
  <a href="./products/chokebit-wiki.cn">跟进进度 ↗</a>
</section>
...
<section id="about" class="mh-about">
  ...
  <p>这里不只保存答案，也保留产品形成过程中的判断：为什么开始、为什么改变方向、什么有效，以及什么最终失败。</p>
