---
title: Chokebit Wiki Product Log
lang: en
description: The public build log of Chokebit Wiki, from fragmented notes to a bilingual security research knowledge system.
translations:
  cn: products/chokebit-wiki.cn
cssclasses:
  - product-build-log
tags:
  - build-in-public
...
<div class="pl-timeline">
  <section>
    ...
    <div><span>EXPERIMENT</span><h3>Added the Product Lab</h3><p>Started documenting goals, stages, key decisions, and next steps—not only the finished articles.</p></div>
  </section>
  <section>
